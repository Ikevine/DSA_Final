...
void help()
{
    ...
    cout << " studentdelete <student_id>                              :Delete student by ID" << endl;
    cout << " studentupdate <current_student_id> <new_student_id>     :Update student ID" << endl;
...
void processCommands()
{
    ...
    do
    {
        ...
        else if (command == "studentdelete")
		{
		    ...
		    if (student_id.empty())
		    {
		        invalidCommand("studentdelete <student_id>");
		    }
		    else
		    {
        ...
        else if (command == "studentupdate")
        
        
		{
		    string current_student_id, new_student_id;
		    iss >> current_student_id >> new_student_id;
		
		    if (current_student_id.empty() || new_student_id.empty())
		    {
		        invalidCommand("studentupdate <current_student_id> <new_student_id>");
		    }
		    else
		    {
		        updateStudentID(current_student_id, new_student_id);
		    }
		}
